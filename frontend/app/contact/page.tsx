...
import { ArrowRight, Mail, Phone, MapPin, Send, Github, Linkedin, Twitter, ArrowUpRight, Sun, Moon, CheckCircle, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        {contactDetails.map((detail, index) => (
          ...
          >
            ...
            <div>
              <div className="text-sm text-slate-500 dark:text-slate-400">{detail.label}</div>
      ...
      <motion.div
        ...
        className="pt-8 border-t border-slate-200 dark:border-slate-700"
      >
        <h4 className="text-lg font-semibold text-black dark:text-white mb-4">Availability</h4>
    ...
    <div className="bg-white dark:bg-black text-black dark:text-white min-h-screen">
      ...
      >
        <motion.div style={{ y }} className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedText delay={0.2} className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
            ...
            <br />
            <span className="text-black dark:text-white">Something Amazing</span>
          </AnimatedText>
          
          <AnimatedText delay={0.4} className="text-xl text-slate-600 dark:text-slate-300 mb-2 max-w-2xl mx-auto leading-relaxed">
            Ready to bring your vision to life? Whether it's web development, game development, 
            or digital art, I'm here to help you create something extraordinary.
          </AnimatedText>
        </motion.div>
      </motion.section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <h2 className="text-3xl font-bold text-black dark:text-white mb-8">Send a Message</h2>
              <ContactForm />
            </motion.div>
      ...
      <section className="py-20 px-6 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedText delay={0.2} className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            Let's discuss your ideas and turn them into reality. I'm always excited to work on new challenges and creative projects.
          </AnimatedText>
