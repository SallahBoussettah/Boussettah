...
router.get(
  ...
  [
    ...
    query("sortBy")
      .optional()
      .isIn(["title", "createdAt", "views", "likes", "priority", "year"]),
  ...
  [
    ...
    body("imageUrl")
      ...
      .custom((value) => {
        ...
        const filePattern = /\.(jpg|jpeg|png|gif|webp|svg)$/i;
        return urlPattern.test(value) || filePattern.test(value);
      })
  ...
  async (req, res) => {
    try {
      ...
      if (!errors.isEmpty()) {
        ...
        console.log("CREATE - Request body imageUrl:", req.body.imageUrl);
        return res.status(400).json({
          message: "Validation failed",
          errors: errors.array(),
        });
